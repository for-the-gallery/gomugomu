...
class Model():
	def __init__(self,args,training=True):
		...
		# output reshape
		outputs_1 = tf.reshape(outputs_1,[args.batch_size,args.seq_length,args.vocab1_size])
		outputs_2 = tf.reshape(outputs_2,[args.batch_size,args.seq_length,args.vocab2_size])
		outputs_3 = tf.reshape(outputs_3,[args.batch_size,args.seq_length,args.vocab3_size])
		...
		self.mean_loss = tf.reduce_mean(loss_1)+tf.reduce_mean(loss_2)+tf.reduce_mean(loss_3)
