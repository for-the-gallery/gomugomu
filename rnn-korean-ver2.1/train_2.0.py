...
with open(os.path.join(save_dir_full,'vocab1.pkl'),'wb') as f:
	cPickle.dump((data_loader.first_arr,data_loader.vocab_1),f)
with open(os.path.join(save_dir_full,'vocab2.pkl'),'wb') as f:
	cPickle.dump((data_loader.second_arr,data_loader.vocab_2),f)
with open(os.path.join(save_dir_full,'vocab3.pkl'),'wb') as f:
	cPickle.dump((data_loader.third_arr,data_loader.vocab_3),f)
